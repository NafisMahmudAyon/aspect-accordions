    ...
    register_post_type(
      ...
      apply_filters("aspect_accordions_posttype", [
        'labels' => [
          ...
          'menu_name'             => $singular,
          'all_items'             => sprintf(
            /* translators: %s: Plural name for the accordion. */
            __('All %s', 'aspect-accordions'),
            $plural
          ),
          'add_new'               => __('Add New', 'aspect-accordions'),
          'add_new_item' => sprintf(
            /* translators: %s: Singular name for the accordion. */
            __('Add %s', 'aspect-accordions'),
            $singular
          ),
          'edit'                  => __('Edit', 'aspect-accordions'),
          'edit_item' => sprintf(
            /* translators: %s: Singular name for the accordion. */
            __('Edit %s', 'aspect-accordions'),
            $singular
          ),
          'new_item' => sprintf(
            /* translators: %s: Singular name for the accordion. */
            __('New %s', 'aspect-accordions'),
            $singular
          ),
          'view'                  => sprintf(
            /* translators: %s: Singular name for the accordion. */
            __('View %s', 'aspect-accordions'),
            $singular
          ),
          'view_item' => sprintf(
            /* translators: %s: Singular name for the accordion. */
          ...
          'search_items' => sprintf(
            /* translators: %s: Plural name for the accordion. */
            __('Search %s', 'aspect-accordions'),
            $plural
          ),
          'not_found' => sprintf(
            /* translators: %s: Plural name for the accordion. */
            __('No %s found', 'aspect-accordions'),
            $plural
          ),
          'not_found_in_trash' => sprintf(
            /* translators: %s: Plural name for the accordion. */
            __('No %s found in trash', 'aspect-accordions'),
            $plural
          ),
          'parent' => sprintf(
            /* translators: %s: Singular name for the accordion. */
            __('Parent %s', 'aspect-accordions'),
            $singular
          ),
        ],
        'description' => sprintf(
          /* translators: %s: Plural name for the accordion. */
          __('This is where you can create and manage %s.', 'aspect-accordions'),
          $plural
        ),
        'public'                => false,
        'show_ui'               => true,
